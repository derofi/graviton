...
```go get github.com/derofi/graviton/...```
...
Example code to open database:
    ...
    import "fmt"
    import "github.com/derofi/graviton"
...
A mini tool to do single thread testing is provided which can be used to perform various tests on memory or disk backend.
    ...
    go run github.com/derofi/graviton/cmd/stress
...
### License 
[GNU General Public License v3.0](https://github.com/derofi/graviton/blob/master/LICENSE)
